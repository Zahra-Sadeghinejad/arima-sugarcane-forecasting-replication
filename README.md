...
![Five-year ARIMA forecast](figures/03_forecast.png)
...
![Observed and fitted sugarcane production](figures/04_observed_vs_fitted.png)
...
![ACF of ARIMA residuals](figures/07_residual_acf.png)
...
The analysis uses relative file paths, so no user-specific path needs to be added to the script.
